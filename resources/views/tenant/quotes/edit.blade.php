                    ...
                    <tbody>
                        @foreach ($quote->items as $index => $item)
                            <tr>
                                ...
                                <td><input type="number" name="items[{{ $index }}][vat_rate]"
                                        class="form-control vat-rate" step="0.01" min="0"
                                        value="{{ $item->vat_rate }}" required></td>
