...
@section('content')
    <style>
        ...
        .user-user-card-header {
            background: linear-gradient(135deg, #086177 0%, #2a89a6 100%);
            color: white;
            padding: 1.5rem 2rem;
...
{{--                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"--}}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('role_id') ? 'is-invalid' : '' }}"
...
{{--                            <select class="form-control select2 {{ $errors->has('roles') ? 'is-invalid' : '' }}" value="{{ old('roles', '') }}" name="role_id" id="roles" multiple>--}}
{{--                                @foreach ($roles as $id => $role)--}}
{{--                                    <option value="{{ $id }}"--}}
...
{{--                        </div>--}}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('teams') ? 'is-invalid' : '' }}" name="team_id[]" id="teams" multiple>
                                @foreach ($teams as $id => $team)
                                    <option value="{{ $id }}"
                                        {{ in_array($id, old('team_id', [])) ? 'selected' : '' }}>{{ $team }}
                                    </option>
                                @endforeach
                            </select>
                            @if ($errors->has('teams'))
                ...
                <div class="user-card mb-4">
                    ...
                    <div class="user-card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control-file" type="file" name="picture" id="picture" accept="image/*">
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="emergency_contact_name"
                                        id="emergency_contact_name" value="{{ old('emergency_contact_name', '') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="emergency_contact_phone"
                                        id="emergency_contact_phone" value="{{ old('emergency_contact_phone', '') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="employee_type" id="employee_type">
                                        <option value="regular" {{ old('employee_type') == 'regular' ? 'selected' : '' }}>
                                            Regular</option>
                                        <option value="contractor"
                                            {{ old('employee_type') == 'contractor' ? 'selected' : '' }}>Contractor
                                        </option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="user-card-body">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="leave_days_allowed" id="leave_days_allowed"
                                value="{{ old('leave_days_allowed', 10) }}">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" step="0.01" name="daily_rate"
                                        id="daily_rate" value="{{ old('daily_rate', 0) }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" step="0.01" name="overtime_rate"
                                        id="overtime_rate" value="{{ old('overtime_rate', 0) }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="bank_account_number"
                                        id="bank_account_number" value="{{ old('bank_account_number', '') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="user-card mb-4">
                    ...
                    <div class="user-card-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="bio" name="bio" maxlength="100" rows="4">Experienced professional with a background in project management and team leadership.</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <button class="user-submit-btn" type="submit">
                        Save User
                    </button>
...
@section('javascript')
    <script>
        window.onload = function() {
            ...
            const form = document.getElementById('user-form'); // Ensure your form has an id="user-form"

            // Retrieve saved password from sessionStorage (if any)
            const savedPassword = sessionStorage.getItem('tmp_password');

            if (savedPassword !== null) {
                // Restore password value
                pwdField.value = savedPassword;
            }

            // Update sessionStorage while user is typing in the password field
            pwdField.addEventListener('input', function() {
                sessionStorage.setItem('tmp_password', pwdField.value);
            });

            // Clear the sessionStorage after successful form submission
            form.addEventListener('submit', function() {
                // Assuming you're handling success on the backend
                sessionStorage.removeItem('tmp_password');
            });
        };
    </script>
